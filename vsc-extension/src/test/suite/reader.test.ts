...
//         expect(pokemon.stats['specialAttack']).toBe(expected_output.stats['specialAttack']);
//         expect(pokemon.stats['specialDefense']).toBe(expected_output.stats['specialDefense']);
